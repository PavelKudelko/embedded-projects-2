...
void calibrateColor(int numOfColor) {
  if (numOfColor == 1) {
    ...
    lcd.setCursor(0, 1);
    lcd.print("R:" + String(FIRST_COLOR.red) + " G:" + String(FIRST_COLOR.green) + " B:" + String(FIRST_COLOR.blue));
    delay(500); 
  }
    ...
    lcd.setCursor(0, 1);
    lcd.print("R:" + String(SECOND_COLOR.red) + " G:" + String(SECOND_COLOR.green) + " B:" + String(SECOND_COLOR.blue));
    delay(500);
  }
    ...
    lcd.setCursor(0, 1);
    lcd.print("R:" + String(THIRD_COLOR.red) + " G:" + String(THIRD_COLOR.green) + " B:" + String(THIRD_COLOR.blue));
    delay(500);
  }
    ...
    lcd.setCursor(0, 1);
    lcd.print("R:" + String(FOURTH_COLOR.red) + " G:" + String(FOURTH_COLOR.green) + " B:" + String(FOURTH_COLOR.blue));
    delay(500);
  }
